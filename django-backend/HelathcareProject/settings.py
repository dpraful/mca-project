"""
Django settings for HelathcareProject project.
...
ROOT_URLCONF = 'HelathcareProject.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'HelathApp' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'HelathcareProject.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS=[os.path.join(BASE_DIR,'static','graphs')]
MEDIA_URL='/media/'
